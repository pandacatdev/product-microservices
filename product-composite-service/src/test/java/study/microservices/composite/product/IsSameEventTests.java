...
import static study.api.event.Event.Type.CREATE;
import static study.api.event.Event.Type.DELETE;
import static study.microservices.composite.product.IsSameEvent.sameEventExceptCreatedAt;
